     ...
     <div class="tab tab-nav-boxed tab-nav-center tab-nav-underline">
         ...
         <div class="tab-content">
             <div class="tab-pane active" id="sign-in">
                 <form class="submit-sign-popup">
                     @csrf
                     <div class="form-group input-login-register">
                         <input type="text" name="account" placeholder="Email/Số điện thoại/Tên đăng nhập" required>
                     </div>
                     <div class="form-group input-login-register ">
                         <input type="password" name="password" placeholder="Mật khẩu" required id="PasswordPup">
                         <div class="eye-password" onclick="showPassword()">
                     ...
                     <div><p id="login_error" style="color:red"></p></div>
                     <div class="link-set mt-3">
                         <a class="reset-password" href="{{ route('fe.resetPassword') }}">Quên mật khẩu</a>
                         <a href="{{ route('fe.register') }}">Đăng kí tài khoản</a>
                     </div>
                     ...
                     <div class="social-icon-link">
                         <a href="{{ route('fe.login.social',['social'=>"facebook",'provider'>"facebook"]) }}" class="link login-pupop-ad" data-provider="">
                             <div class="BnBJFp ml-3">
                                 <i class="fab fa-facebook-f"></i>
                             </div>
                             <div class="_1DQYn2">Facebook</div>
                         </a>
                         <a href="{{ route('fe.login.social',['social'=>"google",'provider'>"google"]) }}" class="login-pupop-ad _1hKScg _2Ct2Hr _1rblAp _2P7qLN">
