...
return [
    ...
    'search_in_selected_folder' => 'Search in the selected folder',
    'sort' => 'Sort',
    ...
    'menu_name' => 'Media',
    'add' => 'Add media',
    'warning_special_characters' => 'Not allow special characters or empty data.',
    'upload_by_url' => 'Upload by URL',
    'file_upload_by_url' => 'File URL',
    'update_copy_write_success' => 'Update Copyright successfully!',
    'update_media_name_success' => 'Update Media Name successfully!',
    ...
    'javascript' => [
        ...
        'is_protected' => 'The file is protected file. You can not use it',
        'invalid_file' => 'The file upload invalid',
        'invalid_file_extensions' => "The file extensions is invalid. Only support :files",
        'invalid_file_size' => "File too big. Max file upload is :size MB",
        'chunk_total_upload' => "Upload chunk don't allow upload multi files",
    ],
